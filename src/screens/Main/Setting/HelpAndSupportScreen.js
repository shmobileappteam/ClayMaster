    ...
    <Container isPadding={false}>
      ...
      >
        <Typography fFamily="barlowRegular400" size={14} mT={10} color={COLORS.black}>
          ...
          assistance with the app, our support team is ready to help.
        </Typography>
        ...
        <TouchableOpacity onPress={handleEmailPress} activeOpacity={0.7}>
          <Flex gap={8} mT={10} algItems="center">
            ...
            <Typography fFamily="barlowRegular400" size={14}>
              Email:{' '}
              <Typography fFamily="barlowBold700" color={COLORS.primary}>
        ...
        <Typography fFamily="barlowRegular400" size={14} mT={10}>
          ...
          with a brief description of your issue, and our team will get back to you.
        </Typography>

        <Typography fFamily="barlowSemiBold600" size={16} mT={20}>
          Screen sleep vs scoring lock:
        </Typography>
        <Typography fFamily="barlowRegular400" size={14} mT={10}>
          If your phone display turns off while scoring, that is your device Auto-Lock
          / Screen Timeout setting (iOS Settings → Display & Brightness → Auto-Lock, or
          Android Display timeout) — not ClayMaster turning the screen off. In Field
          Mode you can also use the lock icon to pause HIT/MISS scoring; set how long
          until auto-lock under Settings → Scoring auto-lock.
        </Typography>
