...
const StationsList = ({
  ...
  return (
    <View style={{}}>
      ...
      >
        <Flex direction="row" jusContent="space-between" mB={8}>
          <Typography size={14} color={COLORS.black100}>
            Total Hits
          </Typography>
          <Typography
            size={14}
        ...
        <Flex direction="row" jusContent="space-between" mB={8}>
          ...
          <Typography size={14} color={COLORS.red} fFamily="barlowSemiBold600">
            {totalMissed}
          </Typography>
        </Flex>
        <Flex direction="row" jusContent="space-between">
          <Typography size={14} color={COLORS.black100}>
            Total Shots
          </Typography>
          <Typography
